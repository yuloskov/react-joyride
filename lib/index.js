...
var componentTypeWithRefs = createChainableTypeChecker(function (props, propName, componentName, location, propFullName) {
  ...
  if (is__default["default"].string(propValue) || is__default["default"].number(propValue) || !reactIs.isValidElementType(propValue) || ![reactIs.Element, reactIs.ForwardRef].includes(reactIs.typeOf(Component))) {
  ...
  _createClass(JoyrideBeacon, [{
    ...
    value: function componentDidMount() {
      ...
      if (process.env.NODE_ENV !== 'production') {
        if (!is__default["default"].domElement(this.beacon)) {
    ...
    value: function render() {
      ...
      if (beaconComponent) {
        ...
        }), /*#__PURE__*/React__default["default"].createElement("div", null, "ksneawea;enaw"));
      }
...
_defineProperty(JoyrideBeacon, "propTypes", {
  ...
  locale: PropTypes__default["default"].object.isRequired,
  nonce: PropTypes__default["default"].string,
  onClickOrHover: PropTypes__default["default"].func.isRequired,
  shouldFocus: PropTypes__default["default"].bool.isRequired,
  styles: PropTypes__default["default"].object.isRequired
});
...
_defineProperty(JoyrideOverlay, "propTypes", {
  ...
  disableOverlay: PropTypes__default["default"].bool.isRequired,
  disableOverlayClose: PropTypes__default["default"].bool,
  disableScrolling: PropTypes__default["default"].bool.isRequired,
  disableScrollParentFix: PropTypes__default["default"].bool.isRequired,
  lifecycle: PropTypes__default["default"].string.isRequired,
  onClickOverlay: PropTypes__default["default"].func.isRequired,
  placement: PropTypes__default["default"].string.isRequired,
  spotlightClicks: PropTypes__default["default"].bool.isRequired,
  spotlightPadding: PropTypes__default["default"].number,
  styles: PropTypes__default["default"].object.isRequired,
  target: PropTypes__default["default"].oneOfType([PropTypes__default["default"].object, PropTypes__default["default"].string]).isRequired
});
...
_defineProperty(JoyrideTooltipContainer, "propTypes", {
  backProps: PropTypes__default["default"].object.isRequired,
  closeProps: PropTypes__default["default"].object.isRequired,
  continuous: PropTypes__default["default"].bool.isRequired,
  index: PropTypes__default["default"].number.isRequired,
  isLastStep: PropTypes__default["default"].bool.isRequired,
  primaryProps: PropTypes__default["default"].object.isRequired,
  size: PropTypes__default["default"].number.isRequired,
  skipProps: PropTypes__default["default"].object.isRequired,
  step: PropTypes__default["default"].object.isRequired,
  tooltipProps: PropTypes__default["default"].object.isRequired
});
...
_defineProperty(JoyrideTooltip, "propTypes", {
  continuous: PropTypes__default["default"].bool.isRequired,
  helpers: PropTypes__default["default"].object.isRequired,
  index: PropTypes__default["default"].number.isRequired,
  isLastStep: PropTypes__default["default"].bool.isRequired,
  setTooltipRef: PropTypes__default["default"].func.isRequired,
  size: PropTypes__default["default"].number.isRequired,
  step: PropTypes__default["default"].object.isRequired
});
  ...
  _createClass(JoyrideStep, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default["default"].createElement("div", {
        ...
        target: step.target
      }, step.floaterProps), step.disableBeacon ? /*#__PURE__*/React__default["default"].createElement("div", null) : /*#__PURE__*/React__default["default"].createElement(JoyrideBeacon, {
...
_defineProperty(JoyrideStep, "propTypes", {
  ...
  continuous: PropTypes__default["default"].bool.isRequired,
  controlled: PropTypes__default["default"].bool.isRequired,
  debug: PropTypes__default["default"].bool.isRequired,
  helpers: PropTypes__default["default"].object.isRequired,
  index: PropTypes__default["default"].number.isRequired,
  lifecycle: PropTypes__default["default"].string.isRequired,
  nonce: PropTypes__default["default"].string,
  setPopper: PropTypes__default["default"].func.isRequired,
  shouldScroll: PropTypes__default["default"].bool.isRequired,
  size: PropTypes__default["default"].number.isRequired,
  status: PropTypes__default["default"].string.isRequired,
  step: PropTypes__default["default"].shape({
    beaconComponent: componentTypeWithRefs,
    content: PropTypes__default["default"].node.isRequired,
    disableBeacon: PropTypes__default["default"].bool,
    disableOverlay: PropTypes__default["default"].bool,
    disableOverlayClose: PropTypes__default["default"].bool,
    disableScrolling: PropTypes__default["default"].bool,
    disableScrollParentFix: PropTypes__default["default"].bool,
    event: PropTypes__default["default"].string,
    floaterProps: PropTypes__default["default"].shape({
      options: PropTypes__default["default"].object,
      styles: PropTypes__default["default"].object,
      wrapperOptions: PropTypes__default["default"].object
    }),
    hideBackButton: PropTypes__default["default"].bool,
    ...
    locale: PropTypes__default["default"].object,
    offset: PropTypes__default["default"].number.isRequired,
    placement: PropTypes__default["default"].oneOf(['top', 'top-start', 'top-end', 'bottom', 'bottom-start', 'bottom-end', 'left', 'left-start', 'left-end', 'right', 'right-start', 'right-end', 'auto', 'center']),
    spotlightClicks: PropTypes__default["default"].bool,
    spotlightPadding: PropTypes__default["default"].number,
    styles: PropTypes__default["default"].object,
    target: PropTypes__default["default"].oneOfType([PropTypes__default["default"].object, PropTypes__default["default"].string]).isRequired,
...
_defineProperty(Joyride, "propTypes", {
  ...
  continuous: PropTypes__default["default"].bool,
  debug: PropTypes__default["default"].bool,
  disableCloseOnEsc: PropTypes__default["default"].bool,
  disableOverlay: PropTypes__default["default"].bool,
  disableOverlayClose: PropTypes__default["default"].bool,
  disableScrolling: PropTypes__default["default"].bool,
  disableScrollParentFix: PropTypes__default["default"].bool,
  ...
  getHelpers: PropTypes__default["default"].func,
  hideBackButton: PropTypes__default["default"].bool,
  locale: PropTypes__default["default"].object,
  nonce: PropTypes__default["default"].string,
  run: PropTypes__default["default"].bool,
  scrollDuration: PropTypes__default["default"].number,
  scrollOffset: PropTypes__default["default"].number,
  scrollToFirstStep: PropTypes__default["default"].bool,
  showProgress: PropTypes__default["default"].bool,
  showSkipButton: PropTypes__default["default"].bool,
  spotlightClicks: PropTypes__default["default"].bool,
  spotlightPadding: PropTypes__default["default"].number,
